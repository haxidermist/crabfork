...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as CRABFORK_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                CRABFORK_HOME: homeDir,
                CRABFORK_CONFIG_PATH: configPath,
                CRABFORK_STATE_DIR: stateDir,
                CRABFORK_OAUTH_DIR: path.join(stateDir, "credentials"),
                CRABFORK_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
