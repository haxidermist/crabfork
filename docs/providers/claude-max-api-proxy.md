...
<Steps>
  ...
  <Step title="Configure Crabfork">
    Point Crabfork at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Crabfork
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Crabfork integration with Claude CLI or API keys.
  </Card>
