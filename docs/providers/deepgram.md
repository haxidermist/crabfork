...
Deepgram is a speech-to-text API. In Crabfork it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Crabfork uploads the audio file to Deepgram and injects the transcript
...
<Steps>
  ...
  <Step title="Send a voice note">
    Send an audio message through any connected channel. Crabfork transcribes it
...
<Note>
Deepgram transcription is **pre-recorded only** (not real-time streaming). Crabfork
