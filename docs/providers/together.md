...
read_when:
  - You want to use Together AI with Crabfork
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    crabfork onboard --auth-choice together-api-key
    ```
  </Step>
...
Crabfork ships this bundled Together catalog:
...
<AccordionGroup>
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `crabfork models list --provider together`
