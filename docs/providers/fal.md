---
title: "fal"
summary: "fal image and video generation setup in Crabfork"
read_when:
  - You want to use fal image generation in Crabfork
...
Crabfork ships a bundled `fal` provider for hosted image and video generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    crabfork onboard --auth-choice fal-api-key
    ```
  </Step>
...
<Tip>
Use `crabfork models list --provider fal` to see the full list of available fal
