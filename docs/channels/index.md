---
summary: "Messaging platforms Crabfork can connect to"
read_when:
  - You want to choose a chat channel for Crabfork
...
Crabfork can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [WeChat](https://www.npmjs.com/package/@tencent-weixin/crabfork-weixin) — Tencent iLink Bot plugin via QR login; private chats only.
...
- Channels can run simultaneously; configure multiple and Crabfork will route per chat.
