---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic Crabfork QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Crabfork QA.
...
- Crabfork-native orchestration later
