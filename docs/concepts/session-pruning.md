...
Crabfork also runs a separate idempotent cleanup for older legacy sessions that
...
Crabfork auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Crabfork does not override them.
