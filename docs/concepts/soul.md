---
summary: "Use SOUL.md to give your Crabfork agent an actual voice instead of generic assistant sludge"
read_when:
...
Crabfork injects it on normal sessions, so it has real weight. If your agent
...
For Crabfork, `SOUL.md` is that layer.
...
Path fixed for Crabfork workspaces: use `SOUL.md`, not `http://SOUL.md`.
