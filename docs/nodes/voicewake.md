...
Crabfork treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.crabfork/settings/voicewake.json`

Shape:

```json
{ "triggers": ["crabfork", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
