---
summary: "First-run setup flow for Crabfork (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Crabfork">
...
<Step title="CLI">
  ...
  The app can install the global `crabfork` CLI via npm, pnpm, or bun.
