---
summary: "Overview of Crabfork onboarding options and flows"
read_when:
...
Crabfork has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `crabfork onboard`                     | Launch the app            |
...
CLI command docs: [`crabfork onboard`](/cli/onboard)

## macOS app onboarding

Open the Crabfork app. The first-run wizard walks you through the same steps
