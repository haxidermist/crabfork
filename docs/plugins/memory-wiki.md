...
If the active memory plugin exposes shared recall artifacts, Crabfork can search
...
currently exposing public bridge inputs yet. Run `crabfork wiki doctor` first,
...
crabfork wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
