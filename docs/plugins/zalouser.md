...
read_when:
  - You want Zalo Personal (unofficial) support in Crabfork
...
Zalo Personal support for Crabfork via a plugin, using native `zca-js` to automate a normal Zalo user account.
