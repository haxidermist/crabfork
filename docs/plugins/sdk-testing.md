...
summary: "Testing utilities and patterns for Crabfork plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Crabfork
plugins.
...
**Import:** `crabfork/plugin-sdk/testing`
...
} from "crabfork/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "crabfork/plugin-sdk/testing";
...
1. **No monolithic root imports** -- `crabfork/plugin-sdk` root barrel is rejected
...
Crabfork uses Vitest with V8 coverage thresholds. For plugin tests:
