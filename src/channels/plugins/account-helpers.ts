...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: CrabforkConfig): string | undefined {
  ...
  function listAccountIds(cfg: CrabforkConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: CrabforkConfig): string {
