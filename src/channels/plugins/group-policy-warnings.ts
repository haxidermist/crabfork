...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: CrabforkConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: CrabforkConfig }>(
  collector: WarningCollector<{ cfg: CrabforkConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: CrabforkConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: CrabforkConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: CrabforkConfig },
>(
  projectCfg: (cfg: CrabforkConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: CrabforkConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: CrabforkConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: CrabforkConfig },
>(params: {
  providerConfigPresent: (cfg: CrabforkConfig) => boolean;
