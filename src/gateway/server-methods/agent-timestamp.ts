 ...
 *
 * @see https://github.com/crabfork/crabfork/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an CrabforkConfig.
 */
export function timestampOptsFromConfig(cfg: CrabforkConfig): TimestampInjectionOptions {
  return {
