...
import type { ConfigValidationIssue, CrabforkConfig } from "../../config/types.crabfork.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: CrabforkConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: CrabforkConfig, next: CrabforkConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadCrabforkPlugins() (called inside
