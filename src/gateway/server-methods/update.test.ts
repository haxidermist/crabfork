...
vi.mock("../../infra/crabfork-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/crabfork-root.js")>(
    "../../infra/crabfork-root.js",
  );
  return {
    ...actual,
    resolveCrabforkPackageRoot: async () => "/tmp/crabfork",
  };
});
