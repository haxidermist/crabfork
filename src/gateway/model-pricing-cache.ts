...
export function collectConfiguredModelPricingRefs(config: CrabforkConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: CrabforkConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
