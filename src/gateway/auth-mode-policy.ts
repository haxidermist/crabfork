...
export function hasAmbiguousGatewayAuthModeConfig(cfg: CrabforkConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: CrabforkConfig): void {
