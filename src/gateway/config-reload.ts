...
export function resolveGatewayReloadSettings(cfg: CrabforkConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: CrabforkConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: CrabforkConfig) => void | Promise<void>;
  ...
  let pendingInProcessConfig: CrabforkConfig | null = null;
  ...
  const queueRestart = (plan: GatewayReloadPlan, nextConfig: CrabforkConfig) => {
    if (restartQueued) {
      return;
    }
    restartQueued = true;
  ...
  const applySnapshot = async (nextConfig: CrabforkConfig) => {
