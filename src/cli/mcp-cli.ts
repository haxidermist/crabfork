...
import { serveCrabforkChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage Crabfork MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose Crabfork channels over MCP stdio")
