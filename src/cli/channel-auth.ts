...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: CrabforkConfig): boolean {
  const key = plugin.id;
...
function resolveConfiguredAuthChannelInput(cfg: CrabforkConfig, mode: ChannelAuthMode): string {
