...
import { readBestEffortConfig, type CrabforkConfig } from "../config/config.js";
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.crabfork.ai/cli/approvals")}\n`,
    );
