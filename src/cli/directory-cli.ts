    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["crabfork directory self --channel slack", "Show the connected account identity."],
          [
            'crabfork directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["crabfork directory groups list --channel discord", "List available groups/channels."],
          [
            "crabfork directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.crabfork.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
