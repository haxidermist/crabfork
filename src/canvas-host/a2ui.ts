...
export const A2UI_PATH = "/__crabfork__/a2ui";

export const CANVAS_HOST_PATH = "/__crabfork__/canvas";

export const CANVAS_WS_PATH = "/__crabfork__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.crabforkCanvasA2UIAction.postMessage(...)
  // - Android: window.crabforkCanvasA2UIAction.postMessage(...)
  const handlerNames = ["crabforkCanvasA2UIAction"];
  ...
  globalThis.Crabfork = globalThis.Crabfork ?? {};
  globalThis.Crabfork.postMessage = postToNode;
  globalThis.Crabfork.sendUserAction = sendUserAction;
  globalThis.crabforkPostMessage = postToNode;
  globalThis.crabforkSendUserAction = sendUserAction;
