...
function buildNoImageGenerationModelConfiguredMessage(cfg: CrabforkConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: CrabforkConfig }) {
