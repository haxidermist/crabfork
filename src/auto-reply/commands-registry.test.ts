...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@crabfork", { botUsername: "crabfork" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@crabfork args", {
        botUsername: "crabfork",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@crabfork: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "crabfork" })).toBe(
      "/help@otherbot",
    );
  });
