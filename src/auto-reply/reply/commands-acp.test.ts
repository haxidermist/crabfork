...
vi.mock("../../agents/acp-spawn.js", () => ({
  resolveAcpSpawnRuntimePolicyError: (params: { cfg?: CrabforkConfig }) =>
...
function createDiscordParams(commandBody: string, cfg: CrabforkConfig = baseCfg) {
...
function createThreadParams(commandBody: string, cfg: CrabforkConfig = baseCfg) {
...
async function runDiscordAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(createDiscordParams(commandBody, cfg), true);
}

async function runThreadAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(createThreadParams(commandBody, cfg), true);
}

async function runTelegramAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
...
async function runTelegramDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runSlackDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
function createMatrixThreadParams(commandBody: string, cfg: CrabforkConfig = baseCfg) {
...
async function runMatrixAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runMatrixThreadAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(createMatrixThreadParams(commandBody, cfg), true);
}

async function runFeishuDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runLineDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runBlueBubblesDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
...
async function runIMessageDmAcpCommand(commandBody: string, cfg: CrabforkConfig = baseCfg) {
  return handleAcpCommand(
    createConversationParams(
      commandBody,
      {
  ...
  it("sanitizes leaked task and runtime details in ACP status output", async () => {
    ...
    hoisted.readAcpSessionEntryMock.mockReturnValue({
      ...
      acp: {
        ...
        lastError: [
          "Crabfork runtime context (internal):",
    ...
    expect(result?.reply?.text).not.toContain("Crabfork runtime context (internal):");
