...
function resolveMentionPatterns(cfg: CrabforkConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: CrabforkConfig | undefined, agentId?: string): RegExp[] {
