...
function resolveAcpStreamCoalesceIdleMs(cfg: CrabforkConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: CrabforkConfig): number {
...
export function resolveAcpProjectionSettings(cfg: CrabforkConfig): AcpProjectionSettings {
