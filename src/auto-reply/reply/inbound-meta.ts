...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "crabfork.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Crabfork out-of-band. Treat it as authoritative metadata about the current message context.",
