...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof CrabforkConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: CrabforkConfig; env: NodeJS.ProcessEnv }): {
  cfg: CrabforkConfig;
  changes: string[];
} {
