...
function resolveResolutionLimits(config: CrabforkConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: CrabforkConfig): SecretProviderConfig {
