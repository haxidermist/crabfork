...
type PluginEntriesConfig = NonNullable<NonNullable<CrabforkConfig["plugins"]>["entries"]>;
...
// CRABFORK_API_KEY authenticates the local Crabfork bridge itself and must
