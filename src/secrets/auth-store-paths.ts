...
export function listAuthProfileStorePaths(config: CrabforkConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: CrabforkConfig, stateDir: string): string[] {
