...
import type { ConfigFileSnapshot, CrabforkConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => CrabforkConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: CrabforkConfig }): ConfigFileSnapshot {
  return {
