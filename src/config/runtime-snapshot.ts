...
let runtimeConfigSnapshot: CrabforkConfig | null = null;
let runtimeConfigSourceSnapshot: CrabforkConfig | null = null;
...
export function getRuntimeConfigSourceSnapshot(): CrabforkConfig | null {
...
export function loadPinnedRuntimeConfig(loadFresh: () => CrabforkConfig): CrabforkConfig {
...
export async function finalizeRuntimeSnapshotWrite(params: {
  nextSourceConfig: CrabforkConfig;
  hadRuntimeSnapshot: boolean;
  hadBothSnapshots: boolean;
  loadFreshConfig: () => CrabforkConfig;
