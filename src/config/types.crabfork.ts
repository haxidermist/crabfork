...
export type CrabforkConfig = {
  meta?: {
    /** Last Crabfork version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Crabfork UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const crabForkConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = CrabforkConfig & {
  readonly [crabForkConfigStateBrand]?: TState;
};
