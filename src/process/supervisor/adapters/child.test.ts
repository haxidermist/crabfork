...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.CRABFORK_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.CRABFORK_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.CRABFORK_SERVICE_MARKER = originalServiceMarker;
    }
  });
