/**
 * Hook system for Crabfork agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("crabfork.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("crabfork.internalHooksEnabled");
