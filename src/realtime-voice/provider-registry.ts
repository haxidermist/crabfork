...
function resolveRealtimeVoiceProviderEntries(cfg?: CrabforkConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: CrabforkConfig): RealtimeVoiceProviderPlugin[] {
