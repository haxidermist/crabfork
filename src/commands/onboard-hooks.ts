...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.crabfork.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("crabfork hooks list")}`,
      `  ${formatCliCommand("crabfork hooks enable <name>")}`,
      `  ${formatCliCommand("crabfork hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
