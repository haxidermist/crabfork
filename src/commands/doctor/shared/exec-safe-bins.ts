...
function collectExecSafeBinScopes(cfg: CrabforkConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: CrabforkConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: CrabforkConfig): {
