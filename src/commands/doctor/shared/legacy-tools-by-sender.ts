...
export function scanLegacyToolsBySenderKeys(cfg: CrabforkConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: CrabforkConfig): {
