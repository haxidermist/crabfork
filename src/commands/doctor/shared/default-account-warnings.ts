...
export function collectMissingDefaultAccountBindingWarnings(cfg: CrabforkConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: CrabforkConfig): string[] {
  const warnings: string[] = [];
