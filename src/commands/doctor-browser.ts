...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: CrabforkConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: CrabforkConfig, deps?: BrowserDoctorDeps) {
  try {
