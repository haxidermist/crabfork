...
import { replaceConfigFile, type CrabforkConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: CrabforkConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as CrabforkConfig;
  ...
  // May trigger loadCrabforkPlugins on cache miss (disk scan + jiti import)
