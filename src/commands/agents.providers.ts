...
function resolveDefaultAccountId(cfg: CrabforkConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: CrabforkConfig): boolean {
...
export function summarizeBindings(cfg: CrabforkConfig, bindings: AgentBinding[]): string[] {
