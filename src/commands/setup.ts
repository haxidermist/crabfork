...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: CrabforkConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: CrabforkConfig): Promise<void> {
