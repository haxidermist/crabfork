...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://crabfork.local")).toBe("https://crabfork.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://crabfork.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: crabfork security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://crabfork.local" },
      ...
      { Item: "Security", Value: "Run: crabfork security audit --deep" },
