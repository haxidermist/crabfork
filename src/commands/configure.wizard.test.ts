...
vi.mock("../config/config.js", () => ({
  CONFIG_PATH: "~/.crabfork/crabfork.json",
...
vi.mock("./onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "~/.crabfork/workspace",
  applyWizardMetadata: (cfg: CrabforkConfig) => cfg,
...
function setupBaseWizardState(config: CrabforkConfig = {}) {
...
describe("runConfigureWizard", () => {
  beforeEach(() => {
    ...
    mocks.setupSearch.mockImplementation(async (cfg: CrabforkConfig) => cfg);
  });
  ...
  it("persists provider-owned web search config changes returned by setupSearch", async () => {
    setupBaseWizardState();
    mocks.setupSearch.mockImplementation(async (cfg: CrabforkConfig) =>
