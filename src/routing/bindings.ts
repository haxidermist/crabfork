...
export function listBindings(cfg: CrabforkConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: CrabforkConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: CrabforkConfig) {
