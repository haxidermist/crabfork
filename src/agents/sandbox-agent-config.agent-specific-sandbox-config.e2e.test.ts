...
async function resolveContext(config: CrabforkConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): CrabforkConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
