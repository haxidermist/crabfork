...
export const DEFAULT_SANDBOX_IMAGE = "crabfork-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "crabfork-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "crabfork-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "crabfork-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "crabfork-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "crabfork-sandbox-browser";
