...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "crabfork-sbx-test",
    runtimeLabel: params.containerName ?? "crabfork-sbx-test",
    containerName: params.containerName ?? "crabfork-sbx-test",
