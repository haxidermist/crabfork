...
import { resolveCrabforkPluginToolInputs } from "./crabfork-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("crabfork plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveCrabforkPluginToolInputs({
      options: {
        config: {} as never,
