...
export function isConfigPathTruthy(config: CrabforkConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["crabfork-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: CrabforkConfig): string[] | undefined {
