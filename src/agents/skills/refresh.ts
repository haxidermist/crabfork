...
function resolveWatchPaths(workspaceDir: string, config?: CrabforkConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: CrabforkConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: CrabforkConfig }) {
