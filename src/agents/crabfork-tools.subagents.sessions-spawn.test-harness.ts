...
export type CreateCrabforkToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateCrabforkToolsOpts) {
...
vi.mock("../config/sessions.js", async () => {
  ...
  return {
    ...
    resolveStorePath: () => "/tmp/crabfork-sessions-spawn-test-store.json",
