...
export function resolveSessionToolsVisibility(cfg: CrabforkConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: CrabforkConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: CrabforkConfig): AgentToAgentPolicy {
