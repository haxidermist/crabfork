...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<CrabforkConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<CrabforkConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: CrabforkConfig): WebSearchConfig {
