export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_CRABFORK_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_CRABFORK_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[CRABFORK_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[CRABFORK_INTERNAL_CONTEXT_END]]";
