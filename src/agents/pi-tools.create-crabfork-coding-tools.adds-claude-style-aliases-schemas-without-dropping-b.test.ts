...
describe("createCrabforkCodingTools", () => {
  it("preserves action enums in normalized schemas", () => {
    const defaultTools = createCrabforkCodingTools({ senderIsOwner: true });
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const disabledOpenAiTools = createCrabforkCodingTools({
    ...
    const anthropicTools = createCrabforkCodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: CrabforkConfig = {
      tools: {
        exec: {
    ...
    const allowed = createCrabforkCodingTools({
    ...
    const denied = createCrabforkCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createCrabforkCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
