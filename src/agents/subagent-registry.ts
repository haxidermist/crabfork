...
type SubagentRegistryDeps = {
  ...
  resolveContextEngine?: (cfg: CrabforkConfig) => Promise<ContextEngine>;
};
...
async function resolveSubagentRegistryContextEngine(cfg: CrabforkConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: CrabforkConfig, runTimeoutSeconds?: number) {
