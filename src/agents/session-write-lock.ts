...
const CLEANUP_STATE_KEY = Symbol.for("crabfork.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("crabfork.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("crabfork.sessionWriteLockWatchdogState");
