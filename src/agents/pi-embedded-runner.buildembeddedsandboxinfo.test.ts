...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/crabfork-sandbox",
    agentWorkspaceDir: "/tmp/crabfork-workspace",
    workspaceAccess: "none",
    runtimeId: "crabfork-sbx-test",
    runtimeLabel: "crabfork-sbx-test",
    containerName: "crabfork-sbx-test",
    ...
    browser: {
      ...
      containerName: "crabfork-sbx-browser-test",
    },
