...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "crabfork:bootstrap-context:full";

export function resolveContextInjectionMode(config?: CrabforkConfig): AgentContextInjection {
