...
function resolveAdaptiveReadMaxBytes(options?: CrabforkReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createCrabforkReadTool(base, {
...
export function createCrabforkReadTool(
  base: AnyAgentTool,
  options?: CrabforkReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
