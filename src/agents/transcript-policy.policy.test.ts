...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.CRABFORK_BUNDLED_PLUGINS_DIR;
  delete env.CRABFORK_SKIP_PROVIDERS;
  delete env.CRABFORK_SKIP_CHANNELS;
  delete env.CRABFORK_SKIP_CRON;
  delete env.CRABFORK_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
