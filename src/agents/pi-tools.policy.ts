...
export function resolveSubagentToolPolicy(cfg?: CrabforkConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: CrabforkConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: CrabforkConfig["tools"];
