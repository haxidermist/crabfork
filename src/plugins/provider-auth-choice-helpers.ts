...
export function applyProviderAuthConfigPatch(cfg: CrabforkConfig, patch: unknown): CrabforkConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: patchModels as NonNullable<
          NonNullable<CrabforkConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  };
...
export function applyDefaultModel(cfg: CrabforkConfig, model: string): CrabforkConfig {
