...
export function applyGoogleGeminiModelDefault(cfg: CrabforkConfig): {
  next: CrabforkConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: CrabforkConfig): CrabforkConfig {
...
export function applyOpenAIConfig(cfg: CrabforkConfig): CrabforkConfig {
...
export function applyOpencodeGoModelDefault(cfg: CrabforkConfig): {
  next: CrabforkConfig;
  changed: boolean;
} {
