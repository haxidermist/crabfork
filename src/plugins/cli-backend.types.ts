...
export type PluginTextTransforms = {
  ...
  /** Rewrites applied to inbound assistant text before Crabfork consumes it. */
...
export type CliBackendPlugin = {
  ...
  /**
   * Whether Crabfork should inject bundle MCP config for this backend.
   *
   * Keep this opt-in. Only backends that explicitly consume Crabfork's bundle
