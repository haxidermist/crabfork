...
function resolveGatewayStartupDreamingPluginIds(config: CrabforkConfig): Set<string> {
...
function resolveExplicitMemorySlotStartupPluginId(config: CrabforkConfig): string | undefined {
