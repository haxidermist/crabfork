...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: CrabforkConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: CrabforkConfig, value: unknown) => void;
  applySelectionConfig?: (config: CrabforkConfig) => CrabforkConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => CrabforkConfig | Promise<CrabforkConfig>;
