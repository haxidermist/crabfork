...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveCrabforkAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: CrabforkConfig): SecretRef {
