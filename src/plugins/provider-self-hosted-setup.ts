...
export function applyProviderDefaultModel(cfg: CrabforkConfig, modelRef: string): CrabforkConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: CrabforkConfig; modelId: string; modelRef: string; profileId: string } {
