...
import type { CrabforkPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: CrabforkPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): CrabforkPluginConfigSchema {
  return {
