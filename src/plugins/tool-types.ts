...
export type CrabforkPluginToolContext = {
...
export type CrabforkPluginToolFactory = (
  ctx: CrabforkPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type CrabforkPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type CrabforkPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
