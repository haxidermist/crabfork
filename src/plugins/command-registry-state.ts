...
import type { CrabforkPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = CrabforkPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("crabfork.pluginCommandsState");
