/**
 * Standalone MCP server that exposes Crabfork plugin-registered tools
...
function resolveTools(config: CrabforkConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  const server = new Server(
    { name: "crabfork-plugin-tools", version: VERSION },
    { capabilities: { tools: {} } },
  );
