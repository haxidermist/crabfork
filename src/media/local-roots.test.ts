...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "crabfork-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "crabfork-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "crabfork-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "crabfork-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "crabfork-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "crabfork-legacy-state");
    const configDir = path.join("/tmp", "crabfork-current-config");
