...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): CrabforkConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): CrabforkConfig {
  return {
