...
const DEFAULT_HOST_PATH = "~/.crabfork/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `Crabfork default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `Crabfork default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
