...
describe("npm registry spec validation", () => {
  it.each([
    "@crabfork/voice-call",
    "@crabfork/voice-call@1.2.3",
    "@crabfork/voice-call@1.2.3-beta.4",
    "@crabfork/voice-call@latest",
    "@crabfork/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/crabfork/crabfork",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    {
      spec: "@crabfork/voice-call@1.2.3-beta.1",
      expected: {
        name: "@crabfork/voice-call",
        raw: "@crabfork/voice-call@1.2.3-beta.1",
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@crabfork/voice-call@latest",
  ...
  it.each([
    {
      spec: "@crabfork/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@crabfork/voice-call@beta"`,
    },
    {
      spec: "@crabfork/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
