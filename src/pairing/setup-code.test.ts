...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("CRABFORK_GATEWAY_TOKEN", "");
    vi.stubEnv("CRABFORK_GATEWAY_PASSWORD", "");
    vi.stubEnv("CRABFORK_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses CRABFORK_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          CRABFORK_GATEWAY_TOKEN: "new-token",
        },
