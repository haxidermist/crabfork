...
export type TtsRuntimeFacade = {
  _test: TtsTestFacade;
  buildTtsSystemPromptHint: (cfg: CrabforkConfig) => string | undefined;
  ...
  resolveTtsConfig: (cfg: CrabforkConfig) => ResolvedTtsConfig;
  resolveTtsPrefsPath: (config: ResolvedTtsConfig) => string;
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: CrabforkConfig) => TtsProvider[];
