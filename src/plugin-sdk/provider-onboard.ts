...
export type { CrabforkConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: CrabforkConfig, ...args: TArgs) => CrabforkConfig;
  applyConfig: (cfg: CrabforkConfig, ...args: TArgs) => CrabforkConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: CrabforkConfig, preset: TParams) => CrabforkConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: CrabforkConfig): {
  next: CrabforkConfig;
  changed: boolean;
} {
