...
import type { CrabforkPluginApi } from "../plugins/types.js";
...
export type { CrabforkPluginToolContext, CrabforkPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: CrabforkConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
