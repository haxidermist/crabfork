...
const shouldWarnCompatImport =
  ...
  process.env.CRABFORK_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "crabfork/plugin-sdk/compat is deprecated for new plugins. Migrate to focused crabfork/plugin-sdk/<subpath> imports. See https://docs.crabfork.ai/plugins/sdk-migration",
    {
      code: "CRABFORK_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.crabfork.ai/plugins/sdk-migration",
    },
  );
}
