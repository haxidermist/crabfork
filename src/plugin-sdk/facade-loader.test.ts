...
const FACADE_LOADER_GLOBAL = "__crabforkTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("crabfork-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("crabfork-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("crabfork-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("crabfork-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("crabfork-facade-loader-circular-");
    process.env.CRABFORK_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("crabfork-facade-loader-throw-");
    process.env.CRABFORK_BUNDLED_PLUGINS_DIR = dir;
