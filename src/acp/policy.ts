...
export function isAcpEnabledByPolicy(cfg: CrabforkConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: CrabforkConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: CrabforkConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: CrabforkConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: CrabforkConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: CrabforkConfig, agentId: string): boolean {
