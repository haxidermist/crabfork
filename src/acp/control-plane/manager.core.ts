...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: CrabforkConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: CrabforkConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: CrabforkConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: CrabforkConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: CrabforkConfig }): Promise<void> {
