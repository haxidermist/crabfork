...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: CrabforkConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: CrabforkConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: CrabforkConfig;
  agentDir?: string;
  listProviders: (cfg?: CrabforkConfig) => CapabilityProviderCandidate[];
}): string[] {
