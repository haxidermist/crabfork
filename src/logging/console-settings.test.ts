...
let originalCrabforkTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalCrabforkTestConsole = process.env.CRABFORK_TEST_CONSOLE;
  process.env.CRABFORK_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalCrabforkTestConsole === undefined) {
    delete process.env.CRABFORK_TEST_CONSOLE;
  } else {
    process.env.CRABFORK_TEST_CONSOLE = originalCrabforkTestConsole;
  }
