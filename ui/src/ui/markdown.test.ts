...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/crabfork");
      expect(html).toContain('<a href="http://github.com/crabfork"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[Crabfork中文](https://docs.crabfork.ai)");
      expect(html).toContain('href="https://docs.crabfork.ai"');
      expect(html).toContain("Crabfork中文</a>");
    });
