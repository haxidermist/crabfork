...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.crabfork/crabfork.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde crabfork dashboard --no-open en tu escritorio.",
    },
    insecure: {
