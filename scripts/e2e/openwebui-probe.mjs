...
const targetModel =
  modelIds.find((id) => id === "crabfork/default") ?? modelIds.find((id) => id === "crabfork");
if (!targetModel) {
  throw new Error(`crabfork model missing from Open WebUI model list: ${JSON.stringify(modelIds)}`);
}
