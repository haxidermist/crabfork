...
const codexRepo = process.env.CRABFORK_CODEX_REPO
  ? path.resolve(process.env.CRABFORK_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches Crabfork bridge assumptions: ${schemaRoot}`,
);
