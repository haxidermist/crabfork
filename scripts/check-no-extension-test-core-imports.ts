...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']crabfork\/plugin-sdk["']/,
    hint: "Use crabfork/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']crabfork\/plugin-sdk\/test-utils["']/,
    hint: "Use crabfork/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']crabfork\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or crabfork/plugin-sdk/testing for public surfaces.",
  },
  {
