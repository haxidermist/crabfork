...
if [[ -z "$version_content" ]]; then
  echo "<h2>Crabfork $VERSION</h2>"
  echo "<p>Latest Crabfork update.</p>"
  echo "<p><a href=\"https://github.com/crabfork/crabfork/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
