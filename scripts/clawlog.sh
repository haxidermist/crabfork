...
show_usage() {
    cat << EOF
clawlog - Crabfork Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Crabfork logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Crabfork logs flow through the macOS unified log (subsystem: ai.crabfork).
