...
# Output:
# - dist/Crabfork.app
# - dist/Crabfork-<version>.zip
# - dist/Crabfork-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.crabfork.mac}"
...
APP="$ROOT_DIR/dist/Crabfork.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Crabfork-$VERSION.zip"
DMG="$ROOT_DIR/dist/Crabfork-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Crabfork-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Crabfork-$VERSION.dSYM.zip"
