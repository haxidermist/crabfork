...
const env = {
  ...process.env,
  CRABFORK_LIVE_TEST: process.env.CRABFORK_LIVE_TEST || "1",
  CRABFORK_LIVE_TEST_QUIET: quietOverride ?? process.env.CRABFORK_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.CRABFORK_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
