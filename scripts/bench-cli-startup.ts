...
const DEFAULT_ENTRY = "crabfork.mjs";
...
function printUsage(): void {
  console.log(`Crabfork CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: crabfork.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "crabfork-cli-bench-"));
