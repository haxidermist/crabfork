...
export const OPTIONAL_BUNDLED_BUILD_ENV = "CRABFORK_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.crabfork?.install?.npmSpec === "string" &&
    packageJson.crabfork.install.npmSpec.trim().length > 0
  );
}
