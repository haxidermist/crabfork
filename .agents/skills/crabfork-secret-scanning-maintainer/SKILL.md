---
name: crabfork-secret-scanning-maintainer
description: Maintainer-only workflow for handling GitHub Secret Scanning alerts on Crabfork. Use when Codex needs to triage, redact, clean up, and resolve secret leakage found in issue comments, issue bodies, PR comments, or other GitHub content.
---

# Crabfork Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/crabfork/crabfork/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/crabfork-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/crabfork/crabfork/issues/63101#issuecomment-xxx",
