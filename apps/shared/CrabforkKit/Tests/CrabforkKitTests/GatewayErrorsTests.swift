...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "crabfork devices approve req-123",
            docsURLString: "https://docs.crabfork.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "crabfork devices approve req-123")
        #expect(error.docsURLString == "https://docs.crabfork.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "crabfork devices approve req-123")
    }
