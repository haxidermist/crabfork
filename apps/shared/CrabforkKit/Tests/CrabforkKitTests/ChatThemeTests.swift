...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = CrabforkChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = CrabforkChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
