...
public enum CrabforkCanvasA2UICommand: String, Codable, Sendable {
...
public struct CrabforkCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct CrabforkCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
