...
public enum CrabforkTalkCommand: String, Codable, Sendable {
...
public struct CrabforkTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct CrabforkTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
