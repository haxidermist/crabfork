...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: CrabforkProtocol.AnyCodable]?
    {
        ...
        return [
            "id": CrabforkProtocol.AnyCodable(identity.deviceId),
            "publicKey": CrabforkProtocol.AnyCodable(publicKey),
            "signature": CrabforkProtocol.AnyCodable(signature),
            "signedAt": CrabforkProtocol.AnyCodable(signedAtMs),
            "nonce": CrabforkProtocol.AnyCodable(nonce),
        ]
    }
}
