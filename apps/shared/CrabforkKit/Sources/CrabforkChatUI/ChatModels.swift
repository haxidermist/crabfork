...
public typealias CrabforkPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias CrabforkPlatformImage = UIImage
#endif

public struct CrabforkChatUsageCost: Codable, Hashable, Sendable {
...
public struct CrabforkChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: CrabforkChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(CrabforkChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct CrabforkChatMessageContent: Codable, Hashable, Sendable {
...
public struct CrabforkChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [CrabforkChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: CrabforkChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [CrabforkChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: CrabforkChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(CrabforkChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([CrabforkChatMessageContent].self, forKey: .content) {
...
public struct CrabforkChatHistoryPayload: Codable, Sendable {
...
public struct CrabforkSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct CrabforkSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [CrabforkSessionPreviewItem]
}

public struct CrabforkSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [CrabforkSessionPreviewEntry]

    public init(ts: Int, previews: [CrabforkSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct CrabforkChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct CrabforkChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct CrabforkAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct CrabforkChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct CrabforkGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct CrabforkPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: CrabforkPlatformImage?
...
public struct CrabforkChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
