...
public struct CrabforkChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct CrabforkChatSessionsDefaults: Codable, Sendable {
...
public struct CrabforkChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct CrabforkChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: CrabforkChatSessionsDefaults?
    public let sessions: [CrabforkChatSessionEntry]
    ...
    public init(
        ...
        sessions: [CrabforkChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
