...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.crabfork.gateway"
    private static let nodeService = "ai.crabfork.node"
    private static let talkService = "ai.crabfork.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.crabfork.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.crabfork.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("crabfork-gateway.log")
    }
