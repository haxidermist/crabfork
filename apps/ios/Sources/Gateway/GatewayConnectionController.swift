...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [CrabforkCapability.canvas.rawValue, CrabforkCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(CrabforkCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(CrabforkCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = CrabforkLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(CrabforkCapability.location.rawValue) }

        caps.append(CrabforkCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(CrabforkCapability.watch.rawValue)
        }
        caps.append(CrabforkCapability.photos.rawValue)
        caps.append(CrabforkCapability.contacts.rawValue)
        caps.append(CrabforkCapability.calendar.rawValue)
        caps.append(CrabforkCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(CrabforkCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            CrabforkScreenCommand.record.rawValue,
            CrabforkSystemCommand.notify.rawValue,
            CrabforkChatCommand.push.rawValue,
        ...
        if caps.contains(CrabforkCapability.camera.rawValue) {
            commands.append(CrabforkCameraCommand.list.rawValue)
            commands.append(CrabforkCameraCommand.snap.rawValue)
            commands.append(CrabforkCameraCommand.clip.rawValue)
        }
        if caps.contains(CrabforkCapability.location.rawValue) {
            commands.append(CrabforkLocationCommand.get.rawValue)
        }
        if caps.contains(CrabforkCapability.device.rawValue) {
            commands.append(CrabforkDeviceCommand.status.rawValue)
            commands.append(CrabforkDeviceCommand.info.rawValue)
        }
        if caps.contains(CrabforkCapability.watch.rawValue) {
            commands.append(CrabforkWatchCommand.status.rawValue)
            commands.append(CrabforkWatchCommand.notify.rawValue)
        }
        if caps.contains(CrabforkCapability.photos.rawValue) {
            commands.append(CrabforkPhotosCommand.latest.rawValue)
        }
        if caps.contains(CrabforkCapability.contacts.rawValue) {
            commands.append(CrabforkContactsCommand.search.rawValue)
            commands.append(CrabforkContactsCommand.add.rawValue)
        }
        if caps.contains(CrabforkCapability.calendar.rawValue) {
            commands.append(CrabforkCalendarCommand.events.rawValue)
            commands.append(CrabforkCalendarCommand.add.rawValue)
        }
        if caps.contains(CrabforkCapability.reminders.rawValue) {
            commands.append(CrabforkRemindersCommand.list.rawValue)
            commands.append(CrabforkRemindersCommand.add.rawValue)
        }
        if caps.contains(CrabforkCapability.motion.rawValue) {
            commands.append(CrabforkMotionCommand.activity.rawValue)
            commands.append(CrabforkMotionCommand.pedometer.rawValue)
        }
