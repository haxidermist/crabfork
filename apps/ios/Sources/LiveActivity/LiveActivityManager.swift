...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.crabfork.ios", category: "LiveActivity")
    private var currentActivity: Activity<CrabforkActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = CrabforkActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<CrabforkActivityAttributes>.activities
    ...
    private func updateCurrent(state: CrabforkActivityAttributes.ContentState) {
    ...
    private func connectingState() -> CrabforkActivityAttributes.ContentState {
        CrabforkActivityAttributes.ContentState(
    ...
    private func idleState() -> CrabforkActivityAttributes.ContentState {
        CrabforkActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> CrabforkActivityAttributes.ContentState {
        CrabforkActivityAttributes.ContentState(
