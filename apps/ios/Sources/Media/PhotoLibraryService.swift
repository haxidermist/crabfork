...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: CrabforkPhotosLatestParams) async throws -> CrabforkPhotosLatestPayload {
        ...
        var results: [CrabforkPhotoPayload] = []
        ...
        return CrabforkPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> CrabforkPhotoPayload
    {
