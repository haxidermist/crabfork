...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .crabforkSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? CrabforkPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? CrabforkPaths.stateDirURL.path
...
extension Notification.Name {
    static let crabforkSelectSettingsTab = Notification.Name("crabforkSelectSettingsTab")
}
