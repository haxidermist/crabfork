...
/// Menu contents for the Crabfork menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Crabfork") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Crabfork Not Configured"
        case .remote:
            "Remote Crabfork Active"
        case .local:
            "Crabfork Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .crabforkSelectSettingsTab, object: tab)
        }
    }
