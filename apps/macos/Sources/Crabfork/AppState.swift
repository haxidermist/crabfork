...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = CrabforkConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = CrabforkConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: CrabforkConfigFile.loadDict(),
        ...
        CrabforkConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/crabfork"
        state.remoteCliPath = ""
        return state
    }
}
