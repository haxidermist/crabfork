...
enum UIStrings {
    static let welcomeTitle = "Welcome to Crabfork"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "crabfork.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: CrabforkChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g crabfork@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: CrabforkChatViewModel(
