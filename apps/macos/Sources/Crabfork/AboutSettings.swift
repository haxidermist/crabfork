...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/crabfork/crabfork") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/crabfork/crabfork")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://crabfork.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "CrabforkBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CrabforkBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "CrabforkGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "CrabforkGitCommit") as? String) ??
            "unknown"
    }
