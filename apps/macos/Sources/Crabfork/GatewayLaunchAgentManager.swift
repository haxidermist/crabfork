...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.crabfork", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".crabfork/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.crabforkCommand(
            subcommand: "gateway",
