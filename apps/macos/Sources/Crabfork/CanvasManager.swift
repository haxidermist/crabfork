...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.crabfork", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Crabfork/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__crabfork__/a2ui/").absoluteString + "?platform=macos"
    }
