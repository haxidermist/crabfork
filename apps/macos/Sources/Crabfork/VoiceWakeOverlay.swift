...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.crabfork", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Crabfork windows, but below the system’s pop-up menus.
