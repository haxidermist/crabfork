...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.crabfork", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return CrabforkConfigFile.defaultWorkspaceURL() }
