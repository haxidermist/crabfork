...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.crabfork", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.crabfork", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [CrabforkChatMessage] = messages.compactMap { item in
