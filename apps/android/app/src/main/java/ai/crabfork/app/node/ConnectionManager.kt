...
import ai.crabfork.app.gateway.GatewayClientInfo
import ai.crabfork.app.gateway.GatewayConnectOptions
import ai.crabfork.app.gateway.GatewayEndpoint
import ai.crabfork.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "CrabforkAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "crabfork-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions {
    return GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "crabfork-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
  }
