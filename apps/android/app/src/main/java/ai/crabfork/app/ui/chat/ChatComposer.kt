...
import ai.crabfork.app.ui.mobileAccentBorderStrong
...
import ai.crabfork.app.ui.mobileSurface
import ai.crabfork.app.ui.mobileText
import ai.crabfork.app.ui.mobileTextSecondary
import ai.crabfork.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.crabfork.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.crabfork.app.ui.mobileFontFamily,
