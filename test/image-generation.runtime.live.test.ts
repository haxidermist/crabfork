...
const providerFilter = parseCsvFilter(process.env.CRABFORK_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.CRABFORK_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.CRABFORK_LIVE_IMAGE_GENERATION_MODELS);
