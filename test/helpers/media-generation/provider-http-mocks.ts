import type { resolveProviderHttpRequestConfig } from "crabfork/plugin-sdk/provider-http";
...
vi.mock("crabfork/plugin-sdk/provider-auth-runtime", () => ({
  resolveApiKeyForProvider: providerHttpMocks.resolveApiKeyForProviderMock,
}));

vi.mock("crabfork/plugin-sdk/provider-http", () => ({
