...
type LoginOpenAICodexOAuth =
  (typeof import("crabfork/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("crabfork/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("crabfork/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("crabfork/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("crabfork/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/provider-auth-login")>(
    "crabfork/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("crabfork/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/provider-auth")>(
    "crabfork/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
