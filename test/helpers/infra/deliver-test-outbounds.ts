...
function resolveSignalMaxBytes(cfg: CrabforkConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: CrabforkConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
