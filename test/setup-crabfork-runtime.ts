...
const WORKER_RUNTIME_STATE = Symbol.for("crabfork.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("crabfork.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: CrabforkConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
