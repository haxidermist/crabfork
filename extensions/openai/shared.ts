...
import { findCatalogTemplate } from "crabfork/plugin-sdk/provider-catalog-shared";
import {
  cloneFirstTemplateModel,
  matchesExactOrPrefix,
  type ProviderPlugin,
} from "crabfork/plugin-sdk/provider-model-shared";
import { OPENAI_RESPONSES_STREAM_HOOKS } from "crabfork/plugin-sdk/provider-stream-family";
...
export function resolveConfiguredOpenAIBaseUrl(cfg: CrabforkConfig | undefined): string {
