...
vi.mock("crabfork/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("crabfork/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("crabfork/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("crabfork/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("crabfork/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("crabfork/plugin-sdk/webhook-ingress");
  return {
    ...actual,
