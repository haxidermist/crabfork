...
import { resolveDangerousNameMatchingEnabled } from "crabfork/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Crabfork config object. */
function getChannelConfig(cfg: CrabforkConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: CrabforkConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.CRABFORK_BOT_NAME ?? "Crabfork";
