/**
 * Synology Chat Channel Plugin for Crabfork.
 *
...
import { createChatChannelPlugin, type ChannelPlugin } from "crabfork/plugin-sdk/channel-core";
import { waitUntilAbort } from "crabfork/plugin-sdk/channel-lifecycle";
import {
...
import { createEmptyChannelDirectoryAdapter } from "crabfork/plugin-sdk/directory-runtime";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "crabfork pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: CrabforkConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: CrabforkConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Crabfork",
        order: 90,
      },
      capabilities: {
