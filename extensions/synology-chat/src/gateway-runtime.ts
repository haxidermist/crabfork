import { DEFAULT_ACCOUNT_ID, type CrabforkConfig } from "crabfork/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "crabfork/plugin-sdk/webhook-ingress";
