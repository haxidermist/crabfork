...
function enableSlackAccount(cfg: CrabforkConfig, accountId: string): CrabforkConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: CrabforkConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: CrabforkConfig; accountId: string }) =>
