...
import { createDedupeCache } from "crabfork/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("crabfork/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
