import { formatInboundEnvelope } from "crabfork/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "crabfork/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("crabfork/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
