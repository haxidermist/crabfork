...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<CrabforkConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<CrabforkConfig["channels"]>["slack"]>>,
): CrabforkConfig {
  return {
    channels: {
      slack: {
