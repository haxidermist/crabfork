...
const providerFilter = parseCsvFilter(process.env.CRABFORK_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.CRABFORK_LIVE_MUSIC_GENERATION_MODELS);
