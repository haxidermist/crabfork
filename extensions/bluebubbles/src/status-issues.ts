...
import { collectIssuesForEnabledAccounts } from "crabfork/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: crabfork channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
