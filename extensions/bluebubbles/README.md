...
This package contains the **BlueBubbles external channel plugin** for Crabfork.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `crabfork/plugin-sdk` helpers.
