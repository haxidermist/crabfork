...
export function applyOpencodeGoProviderConfig(cfg: CrabforkConfig): CrabforkConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: CrabforkConfig): CrabforkConfig {
