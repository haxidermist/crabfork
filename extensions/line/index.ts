...
type RegisteredLineCardCommand = Parameters<CrabforkPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: CrabforkPluginApi): Promise<RegisteredLineCardCommand> {
