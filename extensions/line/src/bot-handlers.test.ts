...
vi.mock("crabfork/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("crabfork/plugin-sdk/channel-pairing", () => ({
...
vi.mock("crabfork/plugin-sdk/command-auth", () => ({
...
vi.mock("crabfork/plugin-sdk/group-access", () => ({
...
vi.mock("crabfork/plugin-sdk/routing", () => ({
