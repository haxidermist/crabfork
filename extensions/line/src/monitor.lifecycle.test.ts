...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "crabfork/plugin-sdk/webhook-request-guards";
...
vi.mock("crabfork/plugin-sdk/reply-runtime", () => ({
...
vi.mock("crabfork/plugin-sdk/webhook-ingress", () => ({
