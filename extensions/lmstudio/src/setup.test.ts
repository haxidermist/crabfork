...
import { resolveAgentModelPrimaryValue } from "crabfork/plugin-sdk/provider-onboard";
import {
  SELF_HOSTED_DEFAULT_CONTEXT_WINDOW,
  type ProviderAuthMethodNonInteractiveContext,
  type ProviderCatalogContext,
} from "crabfork/plugin-sdk/provider-setup";
...
vi.mock("crabfork/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crabfork/plugin-sdk/provider-auth")>();
  return {
    ...actual,
...
vi.mock("crabfork/plugin-sdk/provider-setup", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crabfork/plugin-sdk/provider-setup")>();
  return {
    ...actual,
...
function buildConfig(): CrabforkConfig {
  return {
    models: {
      providers: {
        lmstudio: {
