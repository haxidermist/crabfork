...
import { withAgentModelAliases } from "crabfork/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: CrabforkConfig): CrabforkConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<CrabforkConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
