import { createSubsystemLogger } from "crabfork/plugin-sdk/logging-core";
import type { ModelDefinitionConfig } from "crabfork/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "crabfork/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "crabfork/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to Crabfork model definitions. */
