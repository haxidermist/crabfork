...
import { createMessageToolCardSchema } from "crabfork/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "crabfork/plugin-sdk/channel-config-helpers";
import type {
...
import { createRuntimeOutboundDelegates } from "crabfork/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "crabfork/plugin-sdk/status-helpers";
import { normalizeOptionalString } from "crabfork/plugin-sdk/text-runtime";
import type { ChannelMessageActionName, ChannelPlugin, CrabforkConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: CrabforkConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: CrabforkConfig }>(
