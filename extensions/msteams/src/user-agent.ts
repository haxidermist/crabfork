...
function resolveCrabforkVersion(): string {
  try {
 ...
 * and appends the Crabfork version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Crabfork/<crabfork-version>"
 * Example: "teams.ts[apps]/2.0.5 Crabfork/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Crabfork/${resolveCrabforkVersion()}`;
  return cachedUserAgent;
}
