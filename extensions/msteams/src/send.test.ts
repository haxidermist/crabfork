...
vi.mock("crabfork/plugin-sdk/msteams", () => ({
...
vi.mock("crabfork/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("crabfork/plugin-sdk/text-runtime")>();
  return {
    ...actual,
