...
export function resolveTavilySearchConfig(cfg?: CrabforkConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: CrabforkConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: CrabforkConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
