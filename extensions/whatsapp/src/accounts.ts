...
import type { DmPolicy, GroupPolicy } from "crabfork/plugin-sdk/config-runtime";
import { resolveOAuthDir } from "crabfork/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: CrabforkConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: CrabforkConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: CrabforkConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: CrabforkConfig): ResolvedWhatsAppAccount[] {
