...
import { sleep } from "crabfork/plugin-sdk/text-runtime";
...
vi.mock("crabfork/plugin-sdk/text-runtime", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/text-runtime")>(
