...
export function applyHuggingfaceProviderConfig(cfg: CrabforkConfig): CrabforkConfig {
  return huggingfacePresetAppliers.applyProviderConfig(cfg);
}

export function applyHuggingfaceConfig(cfg: CrabforkConfig): CrabforkConfig {
