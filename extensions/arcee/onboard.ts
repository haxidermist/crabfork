...
export function applyArceeProviderConfig(cfg: CrabforkConfig): CrabforkConfig {
  return arceePresetAppliers.applyProviderConfig(cfg);
}

export function applyArceeConfig(cfg: CrabforkConfig): CrabforkConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

export function applyArceeOpenRouterConfig(cfg: CrabforkConfig): CrabforkConfig {
