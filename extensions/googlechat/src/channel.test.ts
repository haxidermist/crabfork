...
function resolveGoogleChatAccountImpl(params: { cfg: CrabforkConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: CrabforkConfig) => {
...
function createGoogleChatCfg(): CrabforkConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
