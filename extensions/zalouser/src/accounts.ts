...
function mergeZalouserAccountConfig(cfg: CrabforkConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: CrabforkConfig; accountId?: string | null }) {
