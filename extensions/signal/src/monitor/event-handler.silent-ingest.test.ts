...
vi.mock("crabfork/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/hook-runtime")>(
    "crabfork/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
