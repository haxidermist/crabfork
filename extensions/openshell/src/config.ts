...
import { buildPluginConfigSchema, type CrabforkPluginConfigSchema } from "crabfork/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): CrabforkPluginConfigSchema {
