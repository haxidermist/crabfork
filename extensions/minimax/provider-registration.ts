...
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "crabfork/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "crabfork/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: CrabforkPluginApi) {
