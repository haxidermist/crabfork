...
vi.mock("crabfork/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("crabfork/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/crabfork-state",
}));

import type { ProviderResolveDynamicModelContext } from "crabfork/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/crabfork-state/credentials/github-copilot.token.json";
