...
type AgentDefaultsModel = NonNullable<NonNullable<CrabforkConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<CrabforkConfig["agents"]>["defaults"]>["models"];
