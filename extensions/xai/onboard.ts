...
>({
  ...
  resolveParams: (_cfg: CrabforkConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: CrabforkConfig): CrabforkConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: CrabforkConfig): CrabforkConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: CrabforkConfig): CrabforkConfig {
