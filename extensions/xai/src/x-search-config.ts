...
export function resolveLegacyXSearchConfig(config?: CrabforkConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: CrabforkConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: CrabforkConfig): JsonRecord | undefined {
