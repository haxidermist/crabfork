...
function mergeIMessageAccountConfig(cfg: CrabforkConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: CrabforkConfig): ResolvedIMessageAccount[] {
