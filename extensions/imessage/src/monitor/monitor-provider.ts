...
import { normalizeScpRemoteHost } from "crabfork/plugin-sdk/host-runtime";
import { waitForTransportReady } from "crabfork/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "crabfork/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "crabfork/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "crabfork/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "crabfork/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "crabfork/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "crabfork/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "crabfork/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "crabfork/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T crabfork@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., crabfork@192.168.64.3)
