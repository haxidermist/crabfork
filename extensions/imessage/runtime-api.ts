import type { CrabforkConfig as RuntimeApiCrabforkConfig } from "crabfork/plugin-sdk/config-runtime";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiCrabforkConfig["channels"]>["imessage"]>,
