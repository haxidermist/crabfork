import type { ImageGenerationProvider } from "crabfork/plugin-sdk/image-generation";
...
import { assertOkOrThrowHttpError, postJsonRequest } from "crabfork/plugin-sdk/provider-http";
