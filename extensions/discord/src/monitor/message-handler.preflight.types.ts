...
import type { SessionBindingRecord } from "crabfork/plugin-sdk/conversation-runtime";
...
export type LoadedConfig = ReturnType<
  typeof import("crabfork/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("crabfork/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("crabfork/plugin-sdk/config-runtime").CrabforkConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
