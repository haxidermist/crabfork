import type { NativeCommandSpec } from "crabfork/plugin-sdk/command-auth";
import type { CrabforkConfig } from "crabfork/plugin-sdk/config-runtime";
import { clearPluginCommands, registerPluginCommand } from "crabfork/plugin-sdk/plugin-runtime";
...
vi.mock("crabfork/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/plugin-runtime")>(
    "crabfork/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
...
vi.mock("crabfork/plugin-sdk/command-status-runtime", () => ({
...
async function createNativeCommand(cfg: CrabforkConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: CrabforkConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: CrabforkConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("crabfork/plugin-sdk/plugin-runtime")
    >("crabfork/plugin-sdk/plugin-runtime");
    ...
    discordNativeCommandTesting.setMatchPluginCommand(
      runtimeModuleMocks.matchPluginCommand as typeof import("crabfork/plugin-sdk/plugin-runtime").matchPluginCommand,
    );
    discordNativeCommandTesting.setExecutePluginCommand(
      runtimeModuleMocks.executePluginCommand as typeof import("crabfork/plugin-sdk/plugin-runtime").executePluginCommand,
    );
    discordNativeCommandTesting.setDispatchReplyWithDispatcher(
      runtimeModuleMocks.dispatchReplyWithDispatcher as typeof import("crabfork/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher,
    );
