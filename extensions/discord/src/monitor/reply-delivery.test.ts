...
vi.mock("crabfork/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/retry-runtime")>(
    "crabfork/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
