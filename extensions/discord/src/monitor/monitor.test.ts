...
import { buildPluginBindingApprovalCustomId } from "crabfork/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): CrabforkConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/crabfork-sessions-test.json");
