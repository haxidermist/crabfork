...
import { formatAllowlistMatchMeta } from "crabfork/plugin-sdk/allow-from";
import {
  buildMentionRegexes,
...
import { resolveControlCommandGate } from "crabfork/plugin-sdk/command-auth-native";
import { hasControlCommand } from "crabfork/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "crabfork/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "crabfork/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "crabfork/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "crabfork/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "crabfork/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "crabfork/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "crabfork/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("crabfork/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("crabfork/plugin-sdk/conversation-binding-runtime");
