...
import { AcpRuntimeError } from "crabfork/plugin-sdk/acp-runtime";
...
let runtimeEnvModule: typeof import("crabfork/plugin-sdk/runtime-env");
...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): CrabforkConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
describe("monitorDiscordProvider", () => {
  ...
  beforeAll(async () => {
    vi.doMock("crabfork/plugin-sdk/plugin-runtime", async () => {
    ...
    runtimeEnvModule = await import("crabfork/plugin-sdk/runtime-env");
