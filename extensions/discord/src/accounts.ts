...
import type { DiscordAccountConfig, DiscordActionConfig, CrabforkConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: CrabforkConfig): ResolvedDiscordAccount[] {
