...
} from "crabfork/plugin-sdk/channel-secret-basic-runtime";
import { collectNestedChannelTtsAssignments } from "crabfork/plugin-sdk/channel-secret-tts-runtime";

export const secretTargetRegistryEntries = [
  {
    id: "channels.discord.accounts.*.pluralkit.token",
    targetType: "channels.discord.accounts.*.pluralkit.token",
    configFile: "crabfork.json",
