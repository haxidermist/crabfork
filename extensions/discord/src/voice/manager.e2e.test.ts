...
vi.mock("crabfork/plugin-sdk/routing", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/routing")>(
...
vi.mock("crabfork/plugin-sdk/agent-runtime", async () => {
  const actual = await vi.importActual<typeof import("crabfork/plugin-sdk/agent-runtime")>(
