...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("crabfork.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("crabfork.discord.modalEntries");
