...
function createCfg(): CrabforkConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: CrabforkConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: CrabforkConfig, accountId = "default") {
