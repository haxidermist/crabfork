...
import { maxBytesForKind } from "crabfork/plugin-sdk/media-runtime";
import { extensionForMime } from "crabfork/plugin-sdk/media-runtime";
import { unlinkIfExists } from "crabfork/plugin-sdk/media-runtime";
import type { PollInput } from "crabfork/plugin-sdk/media-runtime";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredCrabforkTmpDir();
