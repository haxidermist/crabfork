...
import { collectProviderDangerousNameMatchingScopes } from "crabfork/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: CrabforkConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: CrabforkConfig,
  doctorFixCommand: string,
): { config: CrabforkConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: CrabforkConfig): string[] {
