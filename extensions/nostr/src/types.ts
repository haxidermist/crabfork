...
import { normalizeSecretInputString, type SecretInput } from "crabfork/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: CrabforkConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: CrabforkConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: CrabforkConfig): string {
