...
Nostr DM channel plugin for Crabfork using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Crabfork. It enables your bot to:
...
# Configure crabfork to use local relay
