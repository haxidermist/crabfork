...
import { buildPluginConfigSchema, z, type CrabforkPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: CrabforkPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".crabfork", "wiki", "main");
}
