...
export function resolveSearxngCategories(config?: CrabforkConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: CrabforkConfig): string | undefined {
