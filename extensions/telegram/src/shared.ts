...
import { createChannelPluginBase, type ChannelPlugin } from "crabfork/plugin-sdk/channel-core";
import { getChatChannelMeta } from "crabfork/plugin-sdk/channel-plugin-common";
 ...
 */
function isBlockedByMultiBotGuard(cfg: CrabforkConfig, accountId: string): boolean {
