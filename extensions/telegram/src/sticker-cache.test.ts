...
const TEST_CACHE_DIR = "/tmp/crabfork-test-sticker-cache/telegram";
const TEST_CACHE_FILE = path.join(TEST_CACHE_DIR, "sticker-cache.json");

describe("sticker-cache", () => {
  beforeEach(() => {
    process.env.CRABFORK_STATE_DIR = "/tmp/crabfork-test-sticker-cache";
    fs.rmSync("/tmp/crabfork-test-sticker-cache", { recursive: true, force: true });
