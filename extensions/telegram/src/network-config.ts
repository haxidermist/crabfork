...
import { isTruthyEnvValue, isWSL2Sync } from "crabfork/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "crabfork/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "CRABFORK_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "CRABFORK_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "CRABFORK_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable CRABFORK_TELEGRAM_DNS_RESULT_ORDER
