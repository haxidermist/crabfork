import { resolveNormalizedAccountEntry } from "crabfork/plugin-sdk/account-core";
import type { BaseTokenResolution } from "crabfork/plugin-sdk/channel-contract";
...
import type { TelegramAccountConfig } from "crabfork/plugin-sdk/config-runtime";
import { resolveDefaultSecretProviderAlias } from "crabfork/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "crabfork/plugin-sdk/routing";
import {
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<CrabforkConfig, "secrets">;
  provider: string;
  id: string;
...
export function resolveTelegramToken(
  ...
  // See: https://github.com/crabfork/crabfork/issues/53876
