import { createAccountListHelpers } from "crabfork/plugin-sdk/account-helpers";
...
export function listMattermostAccountIds(cfg: CrabforkConfig): string[] {
  return mattermostAccountHelpers.listAccountIds(cfg);
}

export function resolveDefaultMattermostAccountId(cfg: CrabforkConfig): string {
...
export function listEnabledMattermostAccounts(cfg: CrabforkConfig): ResolvedMattermostAccount[] {
