...
import { mediaKindFromMime } from "crabfork/plugin-sdk/media-runtime";
import { withTempDownloadPath } from "crabfork/plugin-sdk/temp-path";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "crabfork-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "crabfork-feishu-resource-",
