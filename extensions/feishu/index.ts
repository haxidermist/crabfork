...
function registerFeishuDocTools(api: CrabforkPluginApi) {
...
function registerFeishuChatTools(api: CrabforkPluginApi) {
  const register = loadBundledEntryExportSync<(api: CrabforkPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: CrabforkPluginApi) {
  const register = loadBundledEntryExportSync<(api: CrabforkPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: CrabforkPluginApi) {
  const register = loadBundledEntryExportSync<(api: CrabforkPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: CrabforkPluginApi) {
  const register = loadBundledEntryExportSync<(api: CrabforkPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: CrabforkPluginApi) {
  const register = loadBundledEntryExportSync<(api: CrabforkPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
