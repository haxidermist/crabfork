...
import { resolvePreferredCrabforkTmpDir, type CrabforkPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: CrabforkPluginApi): void {
  ...
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredCrabforkTmpDir(), "crabfork-diffs"),
    logger: api.logger,
  });
