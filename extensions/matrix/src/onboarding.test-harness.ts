import type { OutputRuntimeEnv } from "crabfork/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "crabfork/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Crabfork Gateway",
    },
    confirm: {
