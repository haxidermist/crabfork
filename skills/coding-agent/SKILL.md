...
**⚠️ CRITICAL: Never review PRs in Crabfork's own project folder!**
...
8. **NEVER start Codex inside your Crabfork state directory** (`$CRABFORK_STATE_DIR`, default `~/.crabfork`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/crabfork/** - that's the LIVE Crabfork instance!
...
For long-running background tasks, append a wake trigger to your prompt so Crabfork gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
crabfork system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: crabfork system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
